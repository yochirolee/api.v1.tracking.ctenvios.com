/*
  ...
  - The values [DESPACHADO] on the enum `ParcelStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ParcelStatus_new" AS ENUM ('FACTURADO', 'EN_PALLET', 'EN_DESPACHO', 'EN_CONTENEDOR', 'EN_ESPERA_DE_AFORO', 'AFORADO', 'LISTO_PARA_TRASLADO', 'EN_TRASLADO', 'ENTREGADO', 'ENTREGA_FALLIDA', 'ROTO', 'MOJADO', 'CANAL_ROJO', 'FALTANTE', 'NO_DECLARADO');
